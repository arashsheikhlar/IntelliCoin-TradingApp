...
class Graph(Widget):
    ...
    def _redraw_x(self, *args):
        ...
        if self.xlabel:
            ...
            for k, val in self.label_options.items():
                setattr(xlabel, k, val)
...
class Plot(EventDispatcher):
    ...
    def __init__(self, **kvargs):
        super(Plot, self).__init__(**kvargs)
...
class ContourPlot(Plot):
    ...
    def __init__(self, **kvargs):
        super(ContourPlot, self).__init__(**kvargs)
...
class BarPlot(Plot):
    ...
    def __init__(self, *ar, **kv):
        super(BarPlot, self).__init__(*ar, **kv)
